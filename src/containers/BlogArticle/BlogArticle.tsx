          ...
          <div className="content">
            <div className="article-description">
              <section arial-label="quick summary" className="article__summary">
                The present and future of CSS are very bright indeed and if you
                take a pragmatic, progressive approach to your CSS, then things
                will continue to get better and better on your projects, too. In
                this article, we’ll look into masonry layout, :is selector,
                clamp(), ch and ex units, updated text decoration, and a few
                other useful CSS properties.
              </section>
              <section className="article__summary-body">
                <p>
                  <strong>CSS is great </strong>Lorem ipsum dolor sit amet
                  consectetur, adipisicing elit. Consectetur sint delectus in
                  ullam suscipit dolores ratione voluptatem laudantium autem,
                  voluptas aperiam, sequi debitis dicta placeat minus eum vel
                  odit magnam!
                </p>
